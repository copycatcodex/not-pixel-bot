export class Config {
  ...
  static get CUSTOMDELAYINMIN() {
    return Math.floor(Math.random() * (540 - 360 + 1)) + 360; //Random delay betwen 360 and 540 minuter.
  } //CUSTOM DELAY IN MINUTES EX : 60 = 60 minutes
  static TEMPLATE = {
